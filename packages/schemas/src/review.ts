...
export const REVIEW_SPECIFIC_CODES = ["NO_DIFF", "AI_ERROR", "GENERATION_FAILED"] as const;
...
// Explicit interface for proper typing - LensId and ReviewProfile imported from lens.ts
