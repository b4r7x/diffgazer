...
// Boundary mock: node:fs wraps actual rmSync to simulate deletion failures while delegating other fs calls.
...
// Boundary mock: interactive terminal IO; tests suppress output and auto-confirm prompts.
...
import { runRemoveWorkflow } from "./remove.js";
