    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 12 }}>
        <div {...getZoneProps("search")} style={paneStyle("search")}>
          <input ref={searchRef} aria-label="Search" placeholder="Search" style={{ width: "100%" }} />
        </div>
        <div ref={resultsRef} tabIndex={-1} {...getZoneProps("results")} style={paneStyle("results")}>
          Results
        </div>
        <div ref={previewRef} tabIndex={-1} {...getZoneProps("preview")} style={paneStyle("preview")}>
          Preview
        </div>
      </div>
    </div>
