...
|------|-----------------|---------------------|
| Manual copy / shadcn (future) | `npx shadcn add https://diffgazer.com/r/keys/navigation.json` (hosted registry not yet live — see [Hosted Registry Status](../../PACKAGE_GOVERNANCE.md#hosted-registry-status)) | Not available |
