    ...
    >
      <div>
        <p style={{ fontSize: 14, lineHeight: 1.6, marginBottom: 16 }}>
          This page has enough content to scroll. Open the modal to see focus trapping and scroll
          locking in action. While the modal is open, pressing Tab will cycle only through the
          modal's focusable elements, and the background page will not scroll.
        </p>
        <p style={{ fontSize: 14, lineHeight: 1.6, marginBottom: 16 }}>
          Focus trapping is essential for accessible modal dialogs. Without it, users could tab out
          of the modal and interact with background content, which creates a confusing experience.
          The useFocusTrap hook handles this automatically by intercepting Tab and Shift+Tab key
          events.
        </p>
        <p style={{ fontSize: 14, lineHeight: 1.6, marginBottom: 16 }}>
          Scroll locking prevents the background page from scrolling when a modal overlay is
          visible. This is a common UX pattern that keeps the user's attention on the modal content.
          The useScrollLock hook manages this by setting overflow: hidden on the target element.
        </p>
        <p style={{ fontSize: 14, lineHeight: 1.6, marginBottom: 16 }}>
          When the modal closes, both hooks clean up after themselves: focus is restored to the
          previously focused element, and scroll behavior returns to normal. This cleanup is handled
          automatically via React effect cleanup functions.
        </p>
        <p style={{ fontSize: 14, lineHeight: 1.6, marginBottom: 16 }}>
