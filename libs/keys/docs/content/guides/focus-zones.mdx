---
title: Focus zones
description: Manage keyboard navigation across multiple named UI zones with `@diffgazer/keys`.
---

> Try the [Focus Zones demo](https://github.com/b4r7x/diffgazer/tree/main/libs/keys/examples/playground) to see zones in action.
