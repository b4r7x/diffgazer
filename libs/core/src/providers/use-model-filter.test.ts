...
import { useModelFilter } from "./use-model-filter.js";

function makeModel(id: string, name: string, tier: "free" | "paid", description = ""): ModelInfo {
...
describe("useModelFilter", () => {
  it("returns ordered models matching search text and tier filters", () => {
    ...
    expect(modelIds(result.current.filteredModels)).toEqual([
      "gpt-4",
      "gpt-35",
      "claude",
      "gemini",
