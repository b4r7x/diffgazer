/**
 * Canonical JSON serialization, a bounded canonical-JSON parser, and the
 * synchronous SHA-256 over that canonical form.
 *
 ...
 * receipts merely happen to be its first caller.
 */
