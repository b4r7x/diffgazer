...
// Compose the full event union from the three already-named sub-unions. Adding
...
export type FullReviewStreamEvent = BaseReviewStreamEvent | AgentStreamEvent | StepEvent;
