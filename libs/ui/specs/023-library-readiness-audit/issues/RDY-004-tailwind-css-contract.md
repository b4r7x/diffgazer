...
- `libs/ui/package.json:404` exports `theme-base.css`, `theme.css`, and `styles.css`.
...
- `libs/ui/docs/content/getting-started/tailwind-setup.mdx:53` correctly documents package mode with `@source` and `@import "@diffgazer/ui/styles.css"`, but the manual setup section still needs to make `styles.css` canonical for components.
...
- Package-mode docs use `@source "../node_modules/@diffgazer/ui/dist"` plus `@import "@diffgazer/ui/styles.css"`.
