        ...
        <CommandPalette.Content density="dense">
          ...
          <CommandPalette.List>
            ...
            <CommandPalette.Group heading="File">
              <CommandPalette.Item id="new-file" shortcut="⌘N">
                New file
              </CommandPalette.Item>
              <CommandPalette.Item id="save" shortcut="⌘S">
                Save
              </CommandPalette.Item>
              <CommandPalette.Item id="close" shortcut="⌘W">
                Close tab
              </CommandPalette.Item>
              <CommandPalette.Item id="reload" shortcut="⌘R">
                Reload
              </CommandPalette.Item>
            </CommandPalette.Group>
            <CommandPalette.Group heading="View">
              <CommandPalette.Item id="toggle-sidebar" shortcut="⌘\\">
                Toggle sidebar
              </CommandPalette.Item>
              <CommandPalette.Item id="toggle-terminal" shortcut="⌃`">
                Toggle terminal
              </CommandPalette.Item>
