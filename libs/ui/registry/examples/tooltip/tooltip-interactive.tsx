        ...
        <Tooltip.Trigger>
          {(triggerProps) => (
            <button
              ...
              className="border border-foreground/30 px-3 py-1 font-mono text-sm focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-0 opacity-50"
            >
              delete
            </button>
          )}
