...
function createInvalidFixture() {
  ...
  writeFile(resolve(fixtureRoot, "registry/ui/widget/index.tsx"), [
    '"use client";',
    'import { helper } from "@/lib/helper";',
    "export function Widget() { return helper; }",
    "",
  ].join("\n"));
  writeFile(resolve(fixtureRoot, "registry/lib/helper.ts"), "export const helper = 'helper';\n");
  writeFile(resolve(fixtureRoot, "registry/ui/hidden-card/index.ts"), "export const HiddenCard = null;\n");
  writeFile(resolve(fixtureRoot, "registry/ui/keyboard-widget/index.tsx"), "export const KeyboardWidget = null;\n");
