...
const iconSlotBase = "pr-4 shrink-0 inline-flex w-5 items-center justify-center self-center leading-none relative -top-[2px]";
...
export function DefaultItemLayout({ isFocused, isSelected, isDanger, hotkey, icon, children }: DefaultItemLayoutProps) {
