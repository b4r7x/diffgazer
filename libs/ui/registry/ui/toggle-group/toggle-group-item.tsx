...
export function ToggleGroupItem({
  ...
  const isTabTarget = resolveTabTarget(
    isActive, hasSelection, context.containerRef.current, value,
  );
  ...
  return (
    <button
      ...
      onMouseEnter={() => context.onHighlightChange(value)}
      onFocus={() => context.onHighlightChange(value)}
      className={cn(
