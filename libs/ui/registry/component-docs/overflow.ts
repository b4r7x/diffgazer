  ...
  props: {
    Overflow: {
      mode: {
        ...
        required: false,
        defaultValue: '"text"',
        description: "Text clamps string content with optional auto-tooltip; items measures children and renders an overflow indicator for those that do not fit.",
      },
      children: {
      ...
      tooltip: {
        ...
        required: false,
        defaultValue: null,
        description: 'Text mode only. true/ReactNode renders a Tooltip when content is actually clipped (auto-derived from children when true). false disables the tooltip.',
      },
      gap: {
        type: "string",
        required: false,
