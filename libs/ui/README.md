...
|------|-------------|-----------|
| Manual copy / shadcn (future) | `npx shadcn add https://r.b4r7.dev/ui/button.json` (hosted registry not yet live — see [Hosted Registry Status](../../PACKAGE_GOVERNANCE.md#hosted-registry-status)) | Import copied `src/styles/styles.css` |
