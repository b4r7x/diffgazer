...
`CodeBlock` is highlighter-agnostic. It renders structure — header, scrollable area, line numbers, copy button — but does not tokenize code. Pick one of two patterns to color output.
