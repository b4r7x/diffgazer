...
See the [integration demo](/ui/integrations/keys) that combines focus zones, scoped modals, global shortcuts, and multiple @diffgazer/ui components working together with @diffgazer/keys keyboard handling.
