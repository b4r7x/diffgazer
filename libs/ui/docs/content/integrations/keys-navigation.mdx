...
All navigation-enabled `@diffgazer/ui` components (Menu, Tabs, Select, RadioGroup, etc.) use `useNavigation` internally. See [Patterns](/ui/integrations/keys-patterns) for integration examples.
