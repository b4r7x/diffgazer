...
`@diffgazer/keys` is external publish-gated as of June 6, 2026. Use public package install commands only after `npm view @diffgazer/keys version` succeeds. Before publication, validate package mode with a packed workspace tarball.
