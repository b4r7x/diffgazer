...
Install the package. Before publication it is not on npm, so pack it from a checkout of the repository and install that tarball ([Consumption Paths](https://github.com/b4r7x/diffgazer#consumption-paths)):
