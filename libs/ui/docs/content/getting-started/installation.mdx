...
The one-shot `pnpm dlx`/`npx @diffgazer/add` commands become available after the package is published — see [Package managers](#package-managers).
...
## Package managers (future) [#package-managers]
