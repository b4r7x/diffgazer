...
| Menu | `Menu` | `MenuItem`, `MenuDivider` | `selectedId`, `highlighted`, `onHighlightChange`, `onSelect`, `variant` |
| NavigationList | `NavigationList` | `NavigationListItem`, `NavigationListItemTitle`, `NavigationListItemStatus`, `NavigationListItemMeta`, `NavigationListBadge`, `NavigationListSubtitle` | `selectedId`, `highlighted`, `onHighlightChange`, `onSelect`, `onEnter`, `onNavigationBoundaryReached`, `autoFocus`, `focused` |
