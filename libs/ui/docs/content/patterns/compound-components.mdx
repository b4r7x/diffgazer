...
In @diffgazer/ui, several components use this pattern: **Dialog**, **Tabs**, **Menu**, **NavigationList**, and **Toast**. Each has a root component that provides context and child components that consume it.
...
| Menu | `Menu` | `MenuItem`, `MenuDivider` | `selectedId`, `highlighted`, `onSelect`, `variant` |
| NavigationList | `NavigationList` | `NavigationListItem`, `NavigationListItemTitle`, `NavigationListItemStatus`, `NavigationListItemMeta`, `NavigationListBadge`, `NavigationListSubtitle` | `selectedId`, `highlighted`, `onSelect`, `isFocused` |
