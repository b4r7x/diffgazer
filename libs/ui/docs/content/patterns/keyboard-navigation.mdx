...
Menu includes local arrow-key, Home/End, Enter/Space, and typeahead behavior. Control `highlighted` only when the app needs to coordinate highlight state outside the menu:
