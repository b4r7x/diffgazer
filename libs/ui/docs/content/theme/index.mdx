...
Flat surfaces get their depth from a border plus `--surface-1`, not from blur. The one sanctioned shadow is `--shadow-hard`, a hard offset with zero blur, reserved for floating layers with deliberate brutalist emphasis (`Dialog`, `Menu` submenus, `Select` content and `variant="card"`, `CommandPalette`).

| Token          | Dark default                | Light default                                                  |
|----------------|-----------------------------|----------------------------------------------------------------|
| `--shadow-hard` | `4px 4px 0 0 rgb(0 0 0 / 0.9)` | `4px 4px 0 0 color-mix(in oklab, var(--base-fg) 25%, transparent)` |
