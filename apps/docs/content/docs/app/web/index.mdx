...
There is a second mode. Passing `--tui` launches a keyboard-first terminal UI that reviews without leaving the shell. It is an incomplete beta and not the recommended path; web mode is the full experience. See the [terminal UI](/app/tui) page for what it can do today.
