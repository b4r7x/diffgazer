...
| Provider data notice | The one consent that lets reviews send repository content to your provider, and when you accepted it |
...
| State | Primary | Secondary | More |
| --- | --- | --- | --- |
| Not configured | **Configure** | — | every entry disabled, with the reason |
| Key saved, no model | **Select model** | **Update configuration** | Verify · Delete configuration |
| Ready, not active | **Select configuration** | **Change model** | Update configuration · Verify · Delete configuration |
| Active | an **Active** chip, no primary | **Change model** | Update configuration · Verify · Delete configuration |
| Needs attention | the readiness fix (Update configuration, Verify, or Inspect configuration) | Change model or Select model | the rest |
