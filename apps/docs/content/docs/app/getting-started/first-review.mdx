...
- A supported product configuration. The wizard lists all ten selectable products from the [providers reference](/app/reference/providers).
...
1. Pick the product from the ten selectable entries.
