...
Your **product configuration** is the model transport you bring. Diffgazer supports twelve selectable products documented in the [providers reference](/app/reference/providers). Web, Ink, and CLI all consume the same client-safe configuration summaries and readiness language.
