...
**Fix.** Review the supported products and environment requirements. See the [providers reference](/app/reference/providers), then create a configuration for a supported product and delete the retired one.
