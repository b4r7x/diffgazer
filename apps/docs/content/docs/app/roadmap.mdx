...
- wider local-provider coverage on top of the Ollama and Local OpenAI-compatible transports that already ship, starting with a loopback-scoped vLLM profile once schema and abort behavior are proven.
