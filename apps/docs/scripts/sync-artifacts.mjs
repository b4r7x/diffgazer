...
import { normalizeOrigin, REGISTRY_ORIGIN, syncDocsFromArtifacts } from "@diffgazer/registry";
import {
...
for (const lib of artifactLibraries) {
  const demoIndexPath = join(DOCS_ROOT, "src/generated", lib.id, "demo-index.ts");
