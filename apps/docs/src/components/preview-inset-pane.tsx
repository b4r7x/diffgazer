		...
		<div aria-hidden="true" className="@container/inset px-6 py-6 min-w-0">
			<div className="grid grid-cols-1 @[520px]/inset:grid-cols-[1fr_140px] gap-6 items-start">
				<div className="min-w-0">
					...
					<h1 className="text-[22px] font-bold text-foreground leading-tight mb-2.5">
						Sidebar
					</h1>
					<p className="text-muted-foreground text-[13px] leading-relaxed max-w-[56ch] mb-3.5">
						A composable navigation surface for product layouts. Section titles,
						items, badges, and a sticky footer.
					</p>
				...
				<aside className="hidden @[520px]/inset:block sticky top-10 pl-3 border-l border-border/60 text-muted-foreground text-[11px]">
					<p className="uppercase tracking-[0.14em] text-[10px] mb-2.5">
						On this page
					</p>
				...
				<div className="flex flex-col min-w-0 bg-background relative">
					...
					<FauxDocsBody>
						<p className="text-muted-foreground text-[12.5px] leading-7 max-w-[60ch]">
							Compose with{" "}
							<span className="text-foreground font-bold">SidebarHeader</span>,
							<span className="text-foreground font-bold"> SidebarContent</span>
							, and
							<span className="text-foreground font-bold"> SidebarFooter</span>.
							Items support active and disabled states.
						</p>
					</FauxDocsBody>
				</div>
			</div>
