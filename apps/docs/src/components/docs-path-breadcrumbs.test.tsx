...
describe("DocsPathBreadcrumbs", () => {
  ...
  it("shows the sidebar taxonomy section, not the url, for flat pages", () => {
    ...
    render(<DocsPathBreadcrumbs tree={sectionTree("Project", "/ui/changelog")} />);
  ...
  it("does not render nested interactive controls", () => {
    ...
    const { container } = render(
      <DocsPathBreadcrumbs tree={sectionTree("Hooks", "/ui/hooks/composed-refs")} />,
    );
