...
import { firstNavigablePage, fromFumadocsRoot, mapPageTreeForLibrary } from "@/lib/page-tree";
...
const resolveFirstPageSplat = createServerFn({ method: "GET" })
  ...
  .handler(async ({ data }): Promise<string | null> => {
    ...
    const tree = mapPageTreeForLibrary(fromFumadocsRoot(source.pageTree), data.library);
