...
import { type HomeLibrary, type HomeSectionLink, toBrowseRows } from "../data";
...
function findSection(library: HomeLibrary | undefined, name: string): HomeSectionLink | undefined {
...
export function HomeView({ libraries }: { libraries: HomeLibrary[] }) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <main id="main-content" className="flex w-full flex-1 flex-col items-center px-6 py-16">
        <div className="flex w-full max-w-4xl flex-col gap-14 pb-16">
          ...
          <section aria-labelledby="docs-heading" className="flex flex-col gap-6">
            ...
            <p className="max-w-2xl border-l-2 border-foreground pl-4 font-mono text-sm leading-relaxed text-muted-foreground">
              Reference for diffgazer's keyboard-first React UI primitives and the headless keys
              layer they are built on. Public install paths are gated until the registry and npm
              packages are live.
            </p>
          </section>
