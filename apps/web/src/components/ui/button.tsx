  ...
  "inline-flex items-center justify-center font-mono whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--tui-blue] focus-visible:ring-offset-2 focus-visible:ring-offset-[--tui-bg] disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-[--tui-border] bg-transparent text-[--tui-text] hover:bg-[--tui-border]",
        tab: "bg-transparent text-[--tui-text] border-b-2 border-transparent hover:border-b-[--tui-blue] data-[active=true]:border-b-[--tui-blue] data-[active=true]:font-bold",
        toggle:
          "border border-[--tui-border] bg-transparent text-[--tui-text] data-[active=true]:bg-[--tui-blue] data-[active=true]:text-black data-[active=true]:border-[--tui-blue]",
