...
import { makeAgent, makeLogEvents, makeProgressData, renderView } from "../testing/progress-view";
...
describe("ReviewProgressView", () => {
  ...
  it("reaches the pane action buttons with Tab and roams them with arrows", async () => {
    ...
    // The arrows step the row, so the footer stops claiming they switch panes.
