...
describe("active-sessions", () => {
  ...
  describe("getSession - logging", () => {
    it("logs when session is found", () => {
      ...
      createSession(reviewId, projectPath, "abc123", "M  test.ts", true);
    ...
    it("includes event count in log message", () => {
      ...
      const session = createSession(reviewId, projectPath, "abc123", "M  test.ts", true);
  ...
  describe("getActiveSessionForProject - logging", () => {
    it("logs when active session found for project", () => {
      ...
      const result = getActiveSessionForProject(projectPath, "abc123", "M  test.ts", true);
    ...
    it("does not log when no active session found", () => {
      const result = getActiveSessionForProject("/non/existent/project", "abc123", "M  test.ts", true);
    ...
    it("includes event count in log message", () => {
      ...
      getActiveSessionForProject(projectPath, "abc123", "M  test.ts", true);
    ...
    it("returns first matching active session when multiple exist", () => {
      ...
      const session1 = createSession(reviewId1, projectPath, "abc123", "M  test.ts", true);
      markReady(reviewId1);

      const session2 = createSession(reviewId2, projectPath, "abc123", "M  test.ts", true);
      markReady(reviewId2);
