# Project Structure Guidelines (Bulletproof React)

Most of the code lives in the `apps/web/src` folder and follows this structure:
...
NOTE: You do not need all of these folders for every feature. Only include the ones that are necessary for the feature.
