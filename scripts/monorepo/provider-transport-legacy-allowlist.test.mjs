...
const LEGACY_V1_HAS_API_KEY_GUARD_PATHS = new Set([
  ...
  "cli/diffgazer/src/features/providers/components/screen.readiness.test.tsx",
...
const LEGACY_V1_HAS_API_KEY_SURFACE_PATHS = new Set([
  ...
  "cli/server/src/features/review/testing/router-harness.ts",
  ...
  "cli/server/src/shared/lib/config/store-read-path.test.ts",
