...
const failureCases = [
  ...
  },
  {
    ...
    mutate: (root) => setFileMtime(root, "libs/keys/dist/index.js", Date.now() - 120_000),
  },
  {
    // libs/core carries no build in the conforming fixture, so this case seeds a
    // stale one: dist first, backdated, then a source written after it.
