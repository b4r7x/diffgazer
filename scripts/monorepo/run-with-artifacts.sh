...
# rebuild them again. prepare:artifacts intentionally runs with the skip flag
# UNSET so library/docs artifacts are actually (re)built before the command runs.
set -e
